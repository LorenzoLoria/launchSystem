...
for ii = launcher(1):-1:1
    ...
    h = [ h, configuration.geometry.stage{ii}.interstage.length, configuration.stage{ii}.fuelTankH, configuration.stage{ii}.oxTankH-2*configuration.stage{ii}.oxTankR,...
