...
[landLoads] = landLoads(mission, configuration, mer, launcher, staging);
[updatedStructuralMass, mStructGround, tVecGround, idx] = thicknessFunctionGround(mission, launcher, configuration, landLoads);
...
exportStandardizedFigure(groundAxial,'groundAxial',0.55,1.5,'ChangeColors',false,'AddMarkers',false,'overwriteFigure',true,'exportFIG',true,'exportPDF',false,'figurePath','..\..\..\figures\structures')

%% --- Figura 2: Shear Load ---
groundShear = figure(2); 
...
exportStandardizedFigure(groundShear,'groundShear',0.55,1.5,'ChangeColors',false,'AddMarkers',false,'overwriteFigure',true,'exportFIG',true,'exportPDF',false,'figurePath','..\..\..\figures\structures')

%% --- Figura 3: Bending Moment ---
groundBendingMoment = figure(3); 
...
exportStandardizedFigure(groundBendingMoment,'groundBendingMoment',0.55,1.5,'ChangeColors',false,'AddMarkers',false,'overwriteFigure',true,'exportFIG',true,'exportPDF',false,'figurePath','..\..\..\figures\structures')
