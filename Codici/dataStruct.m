...
mission.options.fmincon = optimoptions("fmincon","Display","iter","MaxIterations",200,'MaxFunctionEvaluations',10000,'StepTolerance',1e-8,'OptimalityTolerance',1e-4,'FunctionTolerance',1e-6,'ConstraintTolerance',1e-6,'EnableFeasibilityMode',true,"UseParallel",true);
