...
mission.options.fmincon = optimoptions("fmincon","Display","iter","MaxIterations",100,'MaxFunctionEvaluations',10000,'StepTolerance',1e-15,'OptimalityTolerance',1e-8,'FunctionTolerance',1e-19,'ConstraintTolerance',1e-10,'EnableFeasibilityMode',true);
