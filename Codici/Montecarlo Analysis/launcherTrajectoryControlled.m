function [tt,xx] = launcherTrajectoryControlled(x0,mission,tSpan,nDeval,stageNumber,opt,option2D,windVelXFun,windVelYFun,stateCollocationRef,timeCollocationRef)
...
solution = ode113(@(t,x) launcherDynamicsECIControlled(t, x,stateCollocationRef,timeCollocationRef, mission,stageNumber,opt,option2D,dimensions,engineVec,windVelXFun,windVelYFun),tSpan,x0,options);
