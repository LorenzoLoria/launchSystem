function [timeCollocation, stateCollocation] = totalTrajectoryMontecarlo(launcher,opt,mission,settings,windVelXFun,windVelYFun,thrustDataVec,parforiter)
...
for i = 1:nStages
    ...
    [tt,xx] = launcherTrajectoryMontecarlo(x0,mission,thrustData,tSpan,nDeval,i,opt,settings.trajectoryOption2D,windVelXFun,windVelYFun);
