...
solution = ode113(@(t,x) launcherDynamicsAndControlECI(t, x,thrustData, mission, mer, configuration, launcher, stageNumber, guidancePoints, guidanceTime, gains), tSpan, x0,options);
