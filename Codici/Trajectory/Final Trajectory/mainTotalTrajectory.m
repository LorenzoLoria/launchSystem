...
ind1 = [ind1(:,1,1) ; ind1(:,2,1) ; ind1(:,3,1) ; ind1(:,1,2) ;  ind1(:,2,2) ;  ind1(:,3,2)] ;
...
ind2 = [ind2(:,1,1) ; ind2(:,2,1) ; ind2(:,3,1) ; ind2(:,1,2) ;  ind2(:,2,2) ;  ind2(:,3,2)] ;
...
ind3 = [ind3(:,1,1) ; ind3(:,2,1) ; ind3(:,3,1) ; ind3(:,1,2) ;  ind3(:,2,2) ;  ind3(:,3,2)] ;
...
ind4 = [ind4(:,1,1) ; ind4(:,2,1) ; ind4(:,3,1) ; ind4(:,1,2) ;  ind4(:,2,2) ;  ind4(:,3,2)] ;
...
ind5 = [ind5(:,1,1) ; ind5(:,2,1) ; ind5(:,3,1) ; ind5(:,1,2) ;  ind5(:,2,2) ;  ind5(:,3,2)] ;
...
ind6 = [ind6(:,1,1) ; ind6(:,2,1) ; ind6(:,3,1) ; ind6(:,1,2) ;  ind6(:,2,2) ;  ind6(:,3,2)] ;
